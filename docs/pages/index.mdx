...
<div className="home-content">
  <div className="content-container">
    <h1 className="headline">The easiest way <br className='sm:block hidden'/>Persistence & Effort</h1>
    <p className="subtitle">I often tell myself that when you insist on something for a long time, <br className='sm:block hidden'/>it will be stupid <a className="nextjs-link" href="https://javgo.cn" target="_blank">Javgo</a></p>
    <p className="subtitle">
      <Link className={styles.cta} href="/docs">快速阅读 <span>→</span></Link> 
      <Link
        className={styles.cta}
        href="/docs"
        style={{
          background: 'linear-gradient(146deg, #ff0000, #fbc2eb)',
        }}
      >站点导航 <span>→</span></Link>
    </p>
  </div>
  <style jsx>{`
    ...
    :global(#a11y-card) {
      background-image: url(/assets/home-tip2.png);
      background-position: center 78px;
    }
    @media screen and (max-width: 1300px) {
      :global(#a11y-card) {
        background-image: linear-gradient(to bottom, white, transparent), url(/assets/home-tip2.png);
      }
    }
    ...
    <div className="content-container">
      <Features>
        ...
        <Feature index={7} large id="fs-card" style={{
          color: 'white',
          backgroundImage: 'url(/assets/home-ide.png), url(/assets/gradient-bg.jpeg)',
        ...
        <Feature index={8} id="a11y-card" className='card-with-border' style={{
          ...
          <h3>Make thinking a habit</h3>
          <p>It will do more with less, <br className="show-on-mobile"/>such as <b>design</b> and <b>thinking</b>.</p>
        </Feature>
        <Feature index={2} id="highlighting-card" href="/docs/guide/syntax-highlighting">
          <h3>哪有<br className="show-on-mobile"/>后端不写前端？</h3>
          <p>作为一名合格的 Java 开发还是有必要掌握那么一丢丢前端滴，比如 Vue、React...</p>
        </Feature>
        <Feature index={3} href="/docs/guide/i18n">
          <h3>语言那么多<br className="show-on-mobile"/>总要选几个</h3>
          <p className='mb-4'>栈长计划至少落实 Java & Go 才符合 JAVGO 的初衷，至于前端，那就随缘吧 😐.</p>
          <I18n/>
        </Feature>
        <Feature index={4} centered style={{
          ...
          }}><a href="https://mdxjs.com/blog/v2" target="_blank" style={{ color: 'currentColor' }}>Markdown</a> 是编写技术博客的不二之选, <br className="hide-medium"/>赶紧学起来吧.</p>
        </Feature>
        <Feature index={5} centered className="feat-darkmode" style={{
          ...
          >Persist in <br/>Accumulate <br/>Self-discipline</motion.h3>
        </Feature>
        <Feature index={6} large id="search-card" href="/docs/docs-theme/theme-configuration#search">
          <div style={{ zIndex: 2}}>
            <h3>Full-text search, <br/>explore javgo</h3>
            <p>There are interested content, try to search in the upper right corner, you may have unexpected harvest.</p>
          </div>
