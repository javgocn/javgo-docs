...
{<h1 className="mt-10 mb-4 text-center text-[2.5rem] font-bold tracking-tight">优秀项目推荐</h1>}

{<p className="mb-16 text-center text-lg text-gray-500 dark:text-gray-400">下面是一些感觉还不错的开源项目，感兴趣的赶紧 Start & Fork 吧！</p>}

<Cards>
  <ShowcaseCard title="The GraphThe GraphThe GraphThe GraphThe GraphThe GraphThe Graph" href="https://thegraph.com/docs/en">
